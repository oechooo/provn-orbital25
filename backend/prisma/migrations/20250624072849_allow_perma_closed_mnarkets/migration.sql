...
INSERT INTO "new_Market" ("articleId", "createdAt", "id", "nextResolve", "outcome", "probFalse", "probTrue", "resolveCount", "sharesFalse", "sharesTrue") SELECT "articleId", "createdAt", "id", "nextResolve", "outcome", "probFalse", "probTrue", "resolveCount", "sharesFalse", "sharesTrue" FROM "Market";
DROP TABLE "Market";
