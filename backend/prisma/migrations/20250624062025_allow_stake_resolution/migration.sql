/*
  ...
  - Added the required column `resolved` to the `Stake` table without a default value. This is not possible if the table is not empty.
...
INSERT INTO "new_Stake" ("createdAt", "id", "marketId", "prediction", "stakeAmount", "upside", "userId") SELECT "createdAt", "id", "marketId", "prediction", "stakeAmount", "upside", "userId" FROM "Stake";
DROP TABLE "Stake";
