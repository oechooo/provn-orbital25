...
CREATE TABLE "new_Market" (
    ...
    "lastResolve" DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
...
INSERT INTO "new_Market" ("articleId", "closed", "createdAt", "id", "nextResolve", "outcome", "probFalse", "probTrue", "resolveCount", "sharesFalse", "sharesTrue") SELECT "articleId", "closed", "createdAt", "id", "nextResolve", "outcome", "probFalse", "probTrue", "resolveCount", "sharesFalse", "sharesTrue" FROM "Market";
DROP TABLE "Market";
